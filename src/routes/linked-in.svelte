...
<a href="https://www.linkedin.com/in/mitchell-brown-3653a32ba" aria-label="Linked In" target="_blank">
    <svg width={size} height={size} viewBox="0 0 44 42" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M6 10C8.20914 10 10 8.20914 10 6C10 3.79086 8.20914 2 6 2C3.79086 2 2 3.79086 2 6C2 8.20914 3.79086 10 6 10Z" stroke={color} stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg> 
</a>